...
public class GetMonitorBoardActivityQueryHandler : IRequestHandler<GetMonitorBoardActivityQuery, MonitorBoardActivityModel>
{
    ...
    public GetMonitorBoardActivityQueryHandler(
        IRepository<MonitorBoardActivity> activityRepository,
    ...
    public async Task<MonitorBoardActivityModel> Handle(GetMonitorBoardActivityQuery request, CancellationToken cancellationToken)
    {
        ...
        var guestEnrollments = await _guestEnrollmentRepository.GetAll(x => x.Activity.Id.Equals(activity.Id), x => x.Registrator);
        ...
        return new MonitorBoardActivityModel
        {
            Id = activity.Id,
            Date = activity.Date,
            Name = activity.Name,
