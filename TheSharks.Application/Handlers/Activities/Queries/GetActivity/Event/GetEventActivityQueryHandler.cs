...
public class GetEventActivityQueryHandler : IRequestHandler<GetEventActivityQuery, EventActivityModel>
{
    ...
    public GetEventActivityQueryHandler(
        IRepository<EventActivity> activityRepository,
    ...
    public async Task<EventActivityModel> Handle(GetEventActivityQuery request, CancellationToken cancellationToken)
    {
