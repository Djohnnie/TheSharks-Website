...
public class GetBoardMeetingActivityQueryHandler : IRequestHandler<GetBoardMeetingActivityQuery, BoardMeetingActivityModel>
{
    ...
    public GetBoardMeetingActivityQueryHandler(
        IRepository<BoardMeetingActivity> activityRepository,
    ...
    public async Task<BoardMeetingActivityModel> Handle(GetBoardMeetingActivityQuery request, CancellationToken cancellationToken)
    {
        ...
        return new BoardMeetingActivityModel
        {
            Id = activity.Id,
            Date = activity.Date,
            Name = activity.Name,
